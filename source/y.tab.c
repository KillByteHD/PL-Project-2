...
# define YYTOKENTYPE
  enum yytokentype
  {
    ...
    PREDICATE_INIT = 258,          /* PREDICATE_INIT  */
    PREDICATE_GENDER = 259,        /* PREDICATE_GENDER  */
    PREDICATE_RELATION = 260,      /* PREDICATE_RELATION  */
    SUBJECT = 261,                 /* SUBJECT  */
    OBJECT = 262                   /* OBJECT  */
  };
...
#define YYerror 256
#define YYUNDEF 257
#define PREDICATE_INIT 258
#define PREDICATE_GENDER 259
#define PREDICATE_RELATION 260
#define SUBJECT 261
#define OBJECT 262
...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_PREDICATE_INIT = 3,             /* PREDICATE_INIT  */
  YYSYMBOL_PREDICATE_GENDER = 4,           /* PREDICATE_GENDER  */
  YYSYMBOL_PREDICATE_RELATION = 5,         /* PREDICATE_RELATION  */
  YYSYMBOL_SUBJECT = 6,                    /* SUBJECT  */
  YYSYMBOL_OBJECT = 7,                     /* OBJECT  */
  YYSYMBOL_8_ = 8,                         /* '.'  */
  YYSYMBOL_9_ = 9,                         /* ','  */
  YYSYMBOL_10_ = 10,                       /* ';'  */
